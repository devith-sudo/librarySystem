...
<body style="background-color:#d3d3d3;">
	...
	<nav class="navbar navbar-default navbar-fixed-bottom">
		<div class="container-fluid">
			<label class="navbar-text pull-left">Developed By: Dul Devith</label>
			<label class="navbar-text pull-right">Library System &copy; All rights reserved by Dul Devith 2025</label>
		</div>
	</nav>
</body>
